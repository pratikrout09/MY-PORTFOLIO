  ...
  return (
    <div className='navbar'>
      ...
      <img src={menu_close} onClick={closeMenu} alt='' className='nav-mob-close'/>
        ...
        <li><AnchorLink className="anchor-link" offset={50} href='#project'><p onClick={()=>setMenu("project")}>Projects</p></AnchorLink>{menu=="project"?<img src={underline} alt=''/>:<></>}</li>
        <li><AnchorLink className="anchor-link" offset={50} href='#skill'><p onClick={()=>setMenu("skill")}>Skills</p></AnchorLink>{menu=="skill"?<img src={underline} alt=''/>:<></>}</li>
